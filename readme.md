...
O payload recebido pela API faz validação básica dos campos (presença, tamanho, valores válidos) através de DataAnnotations (`System.ComponentModel.DataAnnotations`).

---

Além disso, é importante notar que todos os componentes contém uma interface definindo o seu contrato. Isso é importante para facilitar a escrita de testes de unidade, isso possibilita fazer mock dos comportamentos de forma simples.
