...
/// </summary>
public interface ISystemPromptRetriever
{
    string GetSystemPromptByProjectName(string projectName);
}
...
public sealed class SystemPromptRetriever(ILogger<SystemPromptRetriever> logger) : ISystemPromptRetriever
{
