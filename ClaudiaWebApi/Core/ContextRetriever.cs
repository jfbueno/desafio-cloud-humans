...
{
    Task<ContextSection[]> GetContextFromEmbeddingsAsync(float[] embeddings);
}
...
/// </param>
public sealed class ContextRetriever(IVectorDBApiClient vectorDbClient, TenantContext tenantContext) : IContextRetriever
{
